    ...
    public static class Builder {
        ...
        public String toString() {
            return "Builder{" +
                    ...
                    ", secondDayNumber=" + secondDayNumber +
                    ", firstMonthNumber=" + firstMonthNumber +
                    ", secondMonthNumber=" + secondMonthNumber +
                    ", yearNumber1=" + yearNumber1 +
                    ", yearNumber2=" + yearNumber2 +
                    ", yearNumber3=" + yearNumber3 +
                    ", yearNumber4=" + yearNumber4 +
